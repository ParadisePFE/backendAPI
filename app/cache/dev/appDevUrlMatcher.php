    ...
    public function match($pathinfo)
    {
        ...
        if (0 === strpos($pathinfo, '/oauth/v2')) {
            ...
            if (0 === strpos($pathinfo, '/oauth/v2/auth')) {
                ...
                if ($pathinfo === '/oauth/v2/auth_logout') {
                    return array (  '_controller' => 'ParadizApiBundle:Security:logout',  '_route' => 'paradiz_oauth_server_auth_logout',);
                }
        ...
        if (0 === strpos($pathinfo, '/api')) {
            // api_articles
            if ($pathinfo === '/api/articles') {
                return array (  '_controller' => 'Paradiz\\ApiBundle\\Controller\\ApiController::articlesAction',  '_route' => 'api_articles',);
            }

            // api_user
            if ($pathinfo === '/api/user') {
                return array (  '_controller' => 'Paradiz\\ApiBundle\\Controller\\ApiController::userAction',  '_route' => 'api_user',);
            }
        ...
        if (0 === strpos($pathinfo, '/hello') && preg_match('#^/hello/(?P<name>[^/]++)$#s', $pathinfo, $matches)) {
            return $this->mergeDefaults(array_replace($matches, array('_route' => 'oc_user_homepage')), array (  '_controller' => 'OCUserBundle:Default:index',));
        }
